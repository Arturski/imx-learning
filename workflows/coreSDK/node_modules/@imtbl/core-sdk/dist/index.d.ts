...
declare const MintsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listMints: (pageSize?: number, cursor?: string, orderBy?: 'transaction_id' | 'token_id' | 'created_at' | 'updated_at', direction?: string, user?: string, status?: string, minTimestamp?: string, maxTimestamp?: string, tokenType?: string, tokenId?: string, assetId?: string, tokenName?: string, tokenAddress?: string, minQuantity?: string, maxQuantity?: string, metadata?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const MintsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listMints(pageSize?: number, cursor?: string, orderBy?: 'transaction_id' | 'token_id' | 'created_at' | 'updated_at', direction?: string, user?: string, status?: string, minTimestamp?: string, maxTimestamp?: string, tokenType?: string, tokenId?: string, assetId?: string, tokenName?: string, tokenAddress?: string, minQuantity?: string, maxQuantity?: string, metadata?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListMintsResponse>>;
    /**
     * Mint tokens in a batch with fees
     * @summary Mint Tokens V2
     * @param {Array<MintRequest>} mintTokensRequestV2 details of tokens to mint
...
declare const NftCheckoutPrimaryApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getMintStatusById: (provider: 'moonpay', id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const NftCheckoutPrimaryApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getMintStatusById(provider: 'moonpay', id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProviderGetMintStatusResponse>>;
    /**
     * gets nft primary transaction by transaction id
     * @summary Get nft primary transaction by id
     * @param {string} transactionId Transaction id
...
declare class NftCheckoutPrimaryApi extends BaseAPI {
     ...
     * @memberof NftCheckoutPrimaryApi
     */
    getMintStatusById(requestParameters: NftCheckoutPrimaryApiGetMintStatusByIdRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ProviderGetMintStatusResponse, any>>;
    /**
     * gets nft primary transaction by transaction id
     * @summary Get nft primary transaction by id
...
declare class ImmutableX {
     ...
     * @throws {@link index.IMXError}
     */
    getMintStatusById(request: NftCheckoutPrimaryApiGetMintStatusByIdRequest): Promise<axios.AxiosResponse<ProviderGetMintStatusResponse, any>>;
    /**
