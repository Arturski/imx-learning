...
export declare class ImmutableXClient {
    ...
    createTradeRequestV3F({ user, orderId, fees, expiration_timestamp, }: ImmutableMethodParams.ImmutableGetSignableTradeV3Params): TE.TaskEither<Error, {
        signableOrderResult: ImmutableMethodResults.ImmutableGetSignableOrderResult;
        signature: string;
    }>;
    createOrderRequestV3F({ user, tokenSell, tokenBuy, amountSell, amountBuy, fees, expiration_timestamp, }: ImmutableMethodParams.ImmutableGetSignableOrderParams): TE.TaskEither<Error, {
        signableOrderResult: ImmutableMethodResults.ImmutableGetSignableOrderResult;
    ...
    createOrderV3F({ user, tokenSell, tokenBuy, amountSell, amountBuy, fees, expiration_timestamp, }: ImmutableMethodParams.ImmutableGetSignableOrderParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableCreateOrderResult>;
    createOrderV3(params: ImmutableMethodParams.ImmutableGetSignableOrderParamsTS): Promise<ImmutableMethodResults.ImmutableCreateOrderResult>;
    ...
    cancelOrderV3F(orderId: ImmutableMethodParams.ImmutableCancelOrderParamsTS): TE.TaskEither<Error, ImmutableMethodResults.ImmutableCancelOrderResult>;
    cancelOrderV3(params: ImmutableMethodParams.ImmutableCancelOrderParamsTS): Promise<ImmutableMethodResults.ImmutableCancelOrderResult>;
    ...
    createTradeV3F({ user, orderId, fees, }: ImmutableMethodParams.ImmutableGetSignableTradeV3Params): TE.TaskEither<Error, ImmutableMethodResults.ImmutableCreateTradeResult>;
    createTradeV3(params: ImmutableMethodParams.ImmutableGetSignableTradeParamsTS): Promise<ImmutableMethodResults.ImmutableCreateTradeResult>;
    ...
    getOrderV3F({ orderId, include_fees, auxiliaryFees, }: ImmutableMethodParams.ImmutableGetOrderParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableGetOrderResult>;
    getOrderV3(params: ImmutableMethodParams.ImmutableGetOrderParamsTS): Promise<ImmutableMethodResults.ImmutableGetOrderResult>;
    ...
    getOrdersV3F(query: ImmutableMethodParams.ImmutableGetOrdersParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableGetOrdersResult>;
    getOrdersV3(params?: ImmutableMethodParams.ImmutableGetOrdersParamsTS): Promise<ImmutableMethodResults.ImmutableGetOrdersResult>;
    ...
    getCurrenciesV3(exchangeType: ImmutableExchangeTypeV3, provider?: ExchangeProvider, include_limits?: boolean): Promise<ImmutableMethodResults.ImmutableGetCurrenciesResultV3>;
    ...
    createExchangeV3(params: ImmutableCreateExchangeV3Params): Promise<ImmutableCreateExchangeV3Response>;
    nftCheckoutPrimary(params: ImmutableNFTCheckoutPrimaryParams): Promise<ImmutableNFTCheckoutPrimaryResponse>;
    nftCheckoutSecondary(params: ImmutableNFTCheckoutSecondaryParams): Promise<ImmutableNFTCheckoutSecondaryResponse>;
    getNFTSecondaryTransactionStatus(transactionId: string): Promise<ImmutableGetNFTSecondaryTransactionStatusResponse>;
    getSecondaryTransactionsHistoryF(params?: ImmutableGetSecondaryTransactionsHistoryParams): TE.TaskEither<Error, ImmutableGetNFTSecondaryTransactionsHistoryResult>;
    getSecondaryTransactionsHistory(params?: ImmutableGetSecondaryTransactionsHistoryParamsTS): Promise<ImmutableGetNFTSecondaryTransactionsHistoryResult>;
}
