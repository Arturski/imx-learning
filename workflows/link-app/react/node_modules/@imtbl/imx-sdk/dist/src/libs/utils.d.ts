...
export declare const assistanceMessage = "For further assistance please visit the ImmutableX support page at https://support.immutable.com";
export declare function payloadId(): number;
export declare function formatError(error: AxiosError | Error): Error;
